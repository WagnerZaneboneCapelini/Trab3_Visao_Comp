[![Open in Dev Containers](https://img.shields.io/static/v1?label=Dev%20Containers&message=Open&color=blue&logo=visualstudiocode)](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/WagnerZaneboneCapelini/Trab3_Visao_Comp) [![Open in GitHub Codespaces](https://img.shields.io/static/v1?label=GitHub%20Codespaces&message=Open&color=blue&logo=github)](https://codespaces.new/WagnerZaneboneCapelini/Trab3_Visao_Comp)

# Contributing to Trab3_Visao_Comp
...
```
   - This setup will:
     ...
     - Install the `Trab3_Visao_Comp` package in editable mode.
...
1. ⭐️ _Dev Container (with container volume)_: click on [Open in Dev Containers](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/WagnerZaneboneCapelini/Trab3_Visao_Comp) to clone this repository in a container volume and create a Dev Container with VS Code.
